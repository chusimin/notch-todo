...
- 展开尺寸**按 Tab 取值**：首页 980×196 / 待办 1080×300 / 应用 1120×540（panelHeight；黑幕从屏顶垂下盖住菜单栏带，总高 = 菜单栏带 + 72px 结构高 + panelHeight）；折叠刘海 **200 ×（菜单栏高 + 6px 唇边）**，黑条贴住刘海位、底缘仅露一线可点
...
| 操作 | 效果 |
|---|---|
| 点击刘海唇边（菜单栏下方露出的一段） | 从刘海垂下展开仪表盘（菜单栏保持可见，面板悬挂其下） |
