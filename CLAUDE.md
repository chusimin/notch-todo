...
- 展开尺寸：按 Tab 取值 —— 首页 980 / 待办 1080 / 应用 1120 宽，窗口贴在菜单栏下方（y = 菜单栏高），总高 = EXPANDED_CHROME_Y(76) + panelHeight(196/300/540)，内容靠顶无黑带；宽度超屏 clamp 到工作区-24
- 展开态布局：黑条退场、菜单栏透出，玻璃面板上沿贴住菜单栏下沿（只圆下方两角，不留缝、不悬浮）；顶栏单行 = [brand「NotchTodo」字标][tabs][弹性中段：应用 Tab 的搜索框][收起钮]
